...
module.exports = async function (context, req) {
    ...
    */
    ...
    const displayName = (req.query.displayName || (req.body && req.body.displayName));
    if (!displayName) {
        context.res = {
            status: 400,
            body: 'Invalid request: must provide a displayName property in the query parameters or request body',
        };
        return;
    }

        ...
        {!React.Children.toArray(children).some(
          child =>
            ...
            (child.type === SheetTitle ||
              (React.isValidElement(child.props?.children) && child.props.children.type === SheetTitle) ||
              (Array.isArray(child.props?.children) && child.props.children.some(c => React.isValidElement(c) && c.type === SheetTitle)))
        ) && (
          <VisuallyHidden>

...
3. You will need to [configure and create a SharePoint Embedded](https://aka.ms/spe-setup)) ContainerTypeID.  Once created, you can use this solution to add new containers to your ContainerType.
